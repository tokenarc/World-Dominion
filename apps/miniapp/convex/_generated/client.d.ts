import { ReactClient } from "convex/react";
...
export const api = {
  ...
  market: {
    ...
    getPlayerListings: (({playerId}: {playerId: string}) => null) as GenericQuery<[{playerId: string}], any>,
  ...
  players: {
    getByUser: (({userId}: {userId: string}) => null) as GenericQuery<[{userId: string}], any>,
    applyRole: (() => Promise.resolve({success: false})) as GenericMutation<[any], any>,
    update: (() => Promise.resolve({success: false})) as GenericMutation<[any], any>,
  },
  wallet: {
    getTransactions: (() => null) as GenericQuery<[any], any>,
    getBalance: (() => null) as GenericQuery<[any], any>,
