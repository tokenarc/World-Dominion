...
exports.dailyMissions = exports.cleanupExpired = exports.worldGazette = exports.resistanceChecker = exports.npcDecisionCycle = exports.electionChecker = exports.warRoundResolver = exports.economyTick = exports.newsLoop = void 0;
...
async function sendTelegramMessage(chatId, text) {
    try {
        await axios_1.default.post(`${BOT_API}/sendMessage`, {
            chat_id: chatId,
            text,
            parse_mode: 'Markdown'
        });
...
// ================================================================
exports.newsLoop = functions.pubsub
...
// ================================================================
exports.economyTick = functions.pubsub
    ...
    try {
        ...
        const wbRes = await axios_1.default.get(wbUrl, { timeout: 15000 });
...
// ================================================================
exports.warRoundResolver = functions.pubsub
    .schedule('every 6 hours')
    .onRun(async () => {
...
// ================================================================
exports.electionChecker = functions.pubsub
    ...
    try {
        ...
        for (const electionDoc of expiredElections.docs) {
            ...
            const winner = Object.entries(votes).sort((a, b) => b[1] - a[1])[0]?.[0] || null;
...
// ================================================================
exports.npcDecisionCycle = functions.pubsub
    .schedule('every 6 hours')
    .onRun(async () => {
    ...
    try {
        ...
        for (const npcDoc of npcPlayers.docs) {
            ...
            if (!npc.currentNation || !npc.currentRole)
                continue;
...
// ================================================================
exports.resistanceChecker = functions.pubsub
    .schedule('every 6 hours')
    .onRun(async () => {
...
// ================================================================
exports.worldGazette = functions.pubsub
    .schedule('0 8 * * *')
    .timeZone('UTC')
    .onRun(async () => {
...
// ================================================================
exports.dailyMissions = functions.pubsub
    .schedule('0 6 * * *')
    .timeZone('UTC')
    .onRun(async () => {
